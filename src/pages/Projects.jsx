...
import { ArrowLeft, Code, ExternalLink, Sun, Moon, Share2, Link as LinkIcon, MessageCircle, Facebook, Twitter, Linkedin, X, Eye, Play } from 'lucide-react';
            ...
            {selectedImage && (
                ...
                >
                    ...
                    <div className="flex flex-col items-center max-w-4xl w-full" onClick={(e) => e.stopPropagation()}>
                        {/* Video or Image */}
                        {playingVideo && getYouTubeId(selectedImage.video_url) ? (
                            ...
                            <div className="relative max-w-full">
                                ...
                                />
                                {/* Play Button Overlay */}
                                {selectedImage.video_url && getYouTubeId(selectedImage.video_url) && (
                                    <button
